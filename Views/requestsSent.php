                ...
                <div class="col-sm-12 tableCol">
                    ...
                    <div class="card">
                        ...
                        { ?>
                            ...
                            <h5 class="card-title m-b-0 heading">Your Sent requests list</h5>
                        ...
                        <div class="table-responsive">
                            ...
                            foreach ($view->userDataSet as $row) // loop inside the variable to retrieve each data
                            {
                                ...
                                '<div onclick="eliminateSent(this)" class="row border rounder m-3 justify-content-around text-center overflow-hidden fontSize">'.
                                ...
                                '<div class="row col-lg-2 notClickable">' .
                                    ...
                                    <div class="col-lg-2 notClickable fCont">
                                        ...
                                        <a onclick="cancelRequest(this, <?php echo "9" . $row->getUserID() ?>)"><button class="btn btn-warning mb-2 f">Cancel</button></a>
                                    </div>
                                </div>
                                <?php
                                }
                                else if (empty($row->getUserPhoto()))
                                {
                                ...
                                '<div onclick="eliminateSent(this)" class="row border rounder m-3 justify-content-around text-center overflow-hidden fontSize">'.
                                    ...
                                    '<div class="col-lg-2 text-nowrap text-truncate">'.'<a class="clickUser" href="../Models/Core.php?user_ID_details='.$row->getUserID().' ">' . $row->getFullName() . '</a>'.'</div>' .
                                    '<div class="col-lg-2 text-nowrap text-truncate">'.'<a class="clickUser" href="../Models/Core.php?user_ID_details='.$row->getUserID().' ">' . $row->getUsername() . '</a>'.'</div>' .
                                '<div class="row col-lg-2 notClickable notClickable">' .
                                    ...
                                    '</div>' ?>
                                    <div class="col-lg-2 fCont">
                                        <!-- if click on this content store the user ID  in the global variable -->
                                        <a onclick="cancelRequest(this, <?php echo "9" . $row->getUserID() ?>)"><button class="btn btn-warning f">Cancel</button></a>
                                    </div>
                                </div>
                         <?php }
                            }
                        ...
                        <div class="table-responsive">
                            ...
                            <h1 class="card-title m-b-0">There are no new Requests sent</h1>
                        </div>
...
<script src="../Javascript/RequestsSent.js"></script>
